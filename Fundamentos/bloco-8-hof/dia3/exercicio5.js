...
function fantasyOrScienceFictionAuthors(array) {
    const objetoBooks = array.filter((element) => (element.genre === 'Ficção Científica' || element.genre === 'Fantasia'));
    return objetoBooks.map((elemento) => (elemento.author.name)).sort();
};
